...
#### Exercise 1
Use the commands we have learned to find the path (location) of the home directory.
...
[Click for solution]([Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2021/blob/main/bash/solutions/ex2a.sh))
...
[Click for solution]([Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2021/blob/main/bash/solutions/ex2b.sh))
...
[Click for solution]([Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2021/blob/main/bash/solutions/ex2c.sh))
...
[Click for solution]([Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2021/blob/main/bash/solutions/ex2d.sh))
...
[Click for solution]([Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2021/blob/main/bash/solutions/ex2e.sh))
...
[Click for solution]([Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2021/blob/main/bash/solutions/ex2f.sh))
...
[Click for solution]([Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2021/blob/main/bash/solutions/ex2g.sh))
...
The "-e" is a flag, which tells the command to do something specific. In this case "-e" says "does this exist".
...
"thing" here becomes a variable. In order to reference a variable, you need to use the correct syntax, which is to have a "$" in the beginning. It is also a good idea to have the whole variable name in curly brackets {}. If you did not use this syntax and just used "thing" instead (without the quotes), bash would think this is a folder called "thing in the current directory.
...
** Hint:** To complete this exercise, you will have to use the most important skill you will learn today. Google! Try to articulate the problem in a sentence and then google it. See if there are solutions already on line that you can just copy and modify.

[Click for solution]([Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2021/blob/main/bash/solutions/ex3.sh))
...
[Click for solution]([Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2021/blob/main/bash/solutions/ex4.sh))
